...
def run_tracker(tracker_name, tracker_param, run_id=None, dataset_name='otb', sequence=None, debug=0, threads=0,
                visdom_info=None,online_update=False):
    ...
    trackers = [Tracker(tracker_name, tracker_param, run_id,online_update=online_update)]
...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, help='Name of parameter file.',default='dimp18')
    ...
    parser.add_argument('--threads', type=int, default=0, help='Nusmber of threads.')
    ...
    run_tracker(args.tracker_name, args.tracker_param, args.runid, args.dataset_name, seq_name, args.debug,
                args.threads, {'use_visdom': args.use_visdom, 'server': args.visdom_server, 'port': args.visdom_port},args.online_update)

...
# ENCODER
cfg.MODEL.VIT = edict()
cfg.MODEL.VIT.IN_CHANNELS = 3
cfg.MODEL.VIT.EMBED_DIM = 768
cfg.MODEL.VIT.DEPTH = 12
cfg.MODEL.VIT.NUM_HEADS = 12
cfg.MODEL.VIT.NUM_CLASSES = 1
cfg.MODEL.VIT.MLP_RATIO = 4
cfg.MODEL.VIT.QKV_BIAS = True
cfg.MODEL.VIT.DROP_RATE = 0.1
cfg.MODEL.VIT.ATTN_DROP_RATE = 0.1
cfg.MODEL.VIT.DROP_PATH_RATE = 0.1
cfg.MODEL.VIT.NORM_LAYER = 'layer_norm'
cfg.MODEL.VIT.INIT_VALUES = 0.
cfg.MODEL.VIT.USE_LEARNABLE_POS_EMB = False

# TRAIN
cfg.TRAIN = edict()
cfg.TRAIN.SAME_ANCHOR = True
...
cfg.DATA.SIZE = 224
cfg.DATA.POS_CENTER_JITTER = 0.5
cfg.DATA.POS_SCALE_JITTER = 0.5
cfg.DATA.NEG_CENTER_JITTER = 2.5
cfg.DATA.NEG_SCALE_JITTER = 1

...
class WarmupCosLR(_LRScheduler):
	def __init__(self, optimizer, warmup_iters, T_max, warmup_factor=0.2, final_value_factor=0.1, last_epoch=-1):
...
# optim = SGD(model, 0.1)
#
# schedule = WarmupCosLR(optim, 100, 500)
# # schedule = WarmUpStepLR(optim, 100, 100)
# optim.zero_grad()
# optim.step()
#
# lr_list = []

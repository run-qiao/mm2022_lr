...
def _setup_legacy_env():
    ...
    sys.modules['dlframework'] = sys.modules['lib.train']
    sys.modules['dlframework.common'] = sys.modules['lib.train']
    importlib.import_module('lib.train.admin')
    sys.modules['dlframework.common.utils'] = sys.modules['lib.train.admin']
    for m in ('model_constructor', 'stats', 'settings', 'local'):
        importlib.import_module('lib.train.admin.' + m)
        sys.modules['dlframework.common.utils.' + m] = sys.modules['lib.train.admin.' + m]

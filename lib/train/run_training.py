...
def main_worker(rank, init_method=None):
    ...
    parser.add_argument('--script', type=str, default="vit", help='Name of the train script.')
    parser.add_argument('--config', type=str, default="base_224", help="Name of the config file.")
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 local_rank=rank, save_dir=args.save_dir, base_seed=args.seed,
...
if __name__ == '__main__':
    ...
    if use_DDP:
        ...
        init_method = f"tcp://{get_master_ip()}:{os.environ['MASTER_PORT']}"

...
class TrackerSiamFC(BaseTracker):

    def __init__(self, param=None, dataset_name=None, **kwargs):
        self.cfg = self.parse_args(**kwargs)
        super(TrackerSiamFC, self).__init__(param)
...
def get_tracker_class():
    ...
    # return TrackerSiamFC(net_path=checkpoint_path)
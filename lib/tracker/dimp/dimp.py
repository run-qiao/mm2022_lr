from lib.tracker.base import BaseTracker
import torch
import torch.nn.functional as F
import math
import time
from lib.test import dcf, TensorList
from lib.test.features.preprocessing import numpy_to_torch,sample_patch_multiscale, sample_patch_transformed
from lib.test.utils.plotting import show_tensor, plot_graph
from lib.test.features import augmentation
import lib.train.data.util.bounding_box_utils as bbutils
from lib.train.models.target_classifier.initializer import FilterInitializerZero
from lib.train.models.layers import activation
